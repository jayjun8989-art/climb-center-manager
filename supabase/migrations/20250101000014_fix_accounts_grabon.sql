-- Fix default accounts (safe to run repeatedly in Supabase SQL Editor).
...
-- Remove legacy emails that block correct login ids.
update auth.users
set
...
-- Re-apply canonical emails + passwords after legacy cleanup.
update auth.users
set
