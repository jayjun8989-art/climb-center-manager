-- Default staff account: login id grabit / password grabit
-- Supabase sign-in email: grabit@oncle.local
-- Role: staff on GRABIT only (re-run safe: upserts password + roles)
...
begin
  ...
  values
    (v_user_id, '11111111-1111-1111-1111-111111111002', 'staff')
